Kenney Game Icons + Expansion Pack
...
Created by https://kenney.nl/

## Untyped usage:

```kotlin
val icons = resourcesVfs["icons.atlas.json"].readAtlas()
...
```kotlin
val icons = resourcesVfs["icons.atlas.json"].readAtlas().toIconsAtlas()
